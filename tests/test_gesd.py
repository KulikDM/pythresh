...
param_grid = list(product(max_outliers, alphas, score_cases))
...
@pytest.mark.parametrize("max_outliers,alpha,score_case", param_grid)
def test_eval(scores, max_outliers, alpha, score_case):
    _, idx = score_case
    s = scores[idx]
