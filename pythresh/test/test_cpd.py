...
class TestCPD(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.methods = ['Dynp', 'KernelCPD', 'Binseg', 'BottomUp']
        cls.transforms = ['cdf', 'kde']

        cls.params = list(product(cls.all_scores, cls.methods, cls.transforms))
    ...
    def test_eval(self):
        for scores, method, transform in self.params:
