...
class TestVAE(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.loss = ['kl', 'mmd']
        cls.latent_dims = [1, 2, 3, 5, 'auto']
        cls.epochs = [5, 10, 15]
        cls.batch_size = [16, 32, 64]

        cls.params = list(product(cls.all_scores, cls.loss, cls.latent_dims,
                                  cls.epochs, cls.batch_size))
    ...
    def test_eval(self):
        for scores, loss, latent_dims, epochs, batch_size in self.params:
            thres = VAE(loss=loss,
