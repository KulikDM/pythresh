...
class TestHIST(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.methods = ['otsu', 'yen', 'isodata', 'li',
                       'minimum', 'triangle']
        cls.nbins = [25, 50, 75, 100, 'auto']

        cls.params = list(product(cls.all_scores, cls.methods, cls.nbins))
    ...
    def test_eval(self):
        for scores, method, nbins in self.params:
            thres = HIST(method=method, nbins=nbins)
