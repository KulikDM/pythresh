...
class TestGAMGMM(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.verbose = [True, False]

        cls.params = list(product(cls.all_scores, cls.skip, cls.verbose))

    def setUp(self):
        self.thres = GAMGMM(skip=True, steps=10)
    ...
    def test_eval(self):
        ...
        for scores, skip, verbose in self.params:
