...
class TestGESD(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.max_outliers = [5, 10, 15, 20, 'auto']
        cls.alphas = [0.025, 0.05, 0.075, 0.1]

        cls.params = list(
            product(cls.all_scores, cls.max_outliers, cls.alphas))
    ...
    def test_eval(self):
        for scores, max_outliers, alpha in self.params:
            thres = GESD(max_outliers=max_outliers, alpha=alpha)
