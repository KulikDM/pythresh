...
latex_documents = [
    (master_doc, "pythresh.tex", "pythresh Documentation", "D Kulik", "manual"),
]
...
man_pages = [(master_doc, "pythresh", "pythresh Documentation", [author], 1)]
...
texinfo_documents = [
    (master_doc, "pythresh", "pythresh Documentation", author, "pythresh", "One line description of project.", "Miscellaneous"),
]
